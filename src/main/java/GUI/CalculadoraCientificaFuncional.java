        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                switch (comando) {
                    ...
                    case "Exp":
                        try {
                            double valor = Double.parseDouble(textoDisplay);
                            // Convierte el número a notación científica con 3 decimales
                            display.setText(NotacionCientifica.convertirANotacionCientifica(valor, 3));
                    ...
                    case "Dec":
                        try {
                            // Convierte desde notación científica a decimal
                            double valorDecimal = NotacionCientifica.parseNotacionCientifica(textoDisplay);
                            display.setText(String.valueOf(valorDecimal));
                        } catch (NumberFormatException ex) {
                            display.setText("Error de formato");
                        }
                        nuevoInput = true;
                        break;
                       // ====Hasta aca llega la funcion de la Notacon Cientifica====
                }
            } catch (NumberFormatException ex) {
